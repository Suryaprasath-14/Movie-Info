...
useEffect(()=>{
  ...
  setGenre(["All Genre", ...listOfUniqueGenre]);
}, [favourites])
...
let filteredArray = [];
 ...
 filteredArray = filteredArray.filter(movie => {
  ...
  return (
    <>
    <div className="mt-6 flex flex-row space-x-2 justify-center">
        {getGenreFilter()}
      </div>
    ...
    <div className='overflow-hidden m-5 border border-gray-300 shadow-md rounded-lg'>
